...
public class ProblemCannibals extends Problem {
    ...
    {   
		...
		if(state.canArray[missL] - state.canArray[cannL] < 0 && state.canArray[missL] > 0) return false;
		if(state.canArray[missR] - state.canArray[cannR] < 0 && state.canArray[missR] > 0) return false;
        //TODO
	...
	public static void main(String[] args) throws Exception {
		...
		noback = canArray[cannL] + canArray[missL] - 1;
